...
import SwiperComponent from "../components/SwiperComponentkr";
import { TouchableOpacity } from "react-native-gesture-handler";
import * as Animatable from "react-native-animatable";

const DetailsScreenKr = ({ navigation }) => {
  return (
    <View
      style={{
        flex: 1,
    ...
    >
      ...
      >
        <View style={{ width: "30%", paddingLeft: 20 }}>
          ...
          >
            <TouchableOpacity onPress={() => navigation.navigate("HotelsKar")}>
              <Image
                style={{ width: 40, height: 40, tintColor: "teal" }}
...
export default DetailsScreenKr;
