...
import SwiperComponent from "../components/SwiperComponentMur";
import { TouchableOpacity } from "react-native-gesture-handler";
import * as Animatable from "react-native-animatable";

const DetailsScreenMur = ({ navigation }) => {
  return (
    <View
      style={{
        flex: 1,
    ...
    >
      ...
      >
        <View style={{ width: "30%", paddingLeft: 20 }}>
          ...
          >
            <TouchableOpacity onPress={() => navigation.navigate("HotelsMur")}>
              <Image
                style={{ width: 40, height: 40, tintColor: "teal" }}
...
export default DetailsScreenMur;
